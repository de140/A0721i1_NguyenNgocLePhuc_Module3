...
CREATE TABLE bo_phan (
    ma_bo_phan INT AUTO_INCREMENT NOT NULL PRIMARY KEY,
...
CREATE TABLE khach_hang (
    ma_khach_hang INT AUTO_INCREMENT NOT NULL PRIMARY KEY,
    ho_ten VARCHAR(45) NOT NULL,
    ngay_sinh DATE NOT NULL,
...
CREATE TABLE kieu_thue (
    ma_kieu_thue INT AUTO_INCREMENT NOT NULL PRIMARY KEY,
    ten_kieu_thue VARCHAR(45) NOT NULL
);
CREATE TABLE loai_dich_vu (
    ma_loai_dich_vu INT AUTO_INCREMENT NOT NULL PRIMARY KEY,
    ten_loai_dich_vu VARCHAR(45) NOT NULL
);
CREATE TABLE dich_vu (
    ma_dich_vu INT AUTO_INCREMENT NOT NULL PRIMARY KEY,
